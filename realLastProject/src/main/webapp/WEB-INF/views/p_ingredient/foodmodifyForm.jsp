			...
			<th colspan="2">
				...
				<tr>
					...
					<td>
						...
						<input class ="input" type="number" name="food_num" maxlength="20" value="${param.food_num}">
					</td>
				</tr>	
		<tr>
			<th colspan="2">
			<input class="inputbutton" type="submit" value="수정확인">
			<input class="inputbutton" type="button" value="수정취소" onclick="window.location='ingredient'">
			</th>
		</tr>
	</table>
	</form>
